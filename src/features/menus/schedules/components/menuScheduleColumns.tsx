      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            {canCancel && (
              <>
                <DropdownMenuItem onClick={() => onCancel(schedule)} className="text-orange-600">
            ...
            <DropdownMenuItem onClick={() => onDelete(schedule)} className="text-red-600 focus:text-red-600">
